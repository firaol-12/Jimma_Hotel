...
export default function DetailRooms(){
    ...
    return(
        <div className="flex flex-col">
            ...
            style={{
                backgroundImage: "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)),url('https://res.cloudinary.com/djw0srhou/image/upload/v1764915634/g1_2_gyrzca.jpg')",
                backgroundSize: "cover",
                backgroundPosition: "center",
            }}
            > 
                <h1 data-aos="zoom-in" data-aos-once="false" className="text-4xl font1">Single Room</h1>
            ...
            <div className="px-10 md:px-30">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center py-4">
                    <div data-aos="fade-right" data-aos-once="false" className="pl-2 border-l-5 border-amber-300">
                        <h1 className="text-3xl font1">Standard Single Room</h1>
                    </div>
