...
export default function Home(){
    ...
    return(
        <div className="h-screen w-full m-0 p-0 flex justify-center md:justify-start items-center md:px-30 text-white"
            style={{
        ...
        >
            <div className="flex flex-col px-0 md:px-0 md:w-2/4 gap-5">
